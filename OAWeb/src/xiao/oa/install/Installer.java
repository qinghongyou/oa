...
public class Installer {
	...
	public void install() {
		...
		menu1 = new Privilege("个人信息", "/man_list", menu);
		menu2 = new Privilege("修改密码", "/man_update", menu);

		session.save(menu);
		session.save(menu1);
		session.save(menu2);
		
		menu = new Privilege("系统概述", null, null);
		menu1 = new Privilege("系统信息", "/system_list", menu);
		menu2 = new Privilege("联系我们", "/system_link", menu);
		menu3 = new Privilege("版权所有", "/system_copyright", menu);
