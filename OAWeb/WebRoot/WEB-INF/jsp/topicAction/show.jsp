			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td width="3" class="ForumPageTableTitleLeft">&nbsp;</td>
					...
					<td class="ForumPageTableTitle" align="right" style="padding-right:12px;">
						...
						<a href="#" onclick="return false"><img border="0" src="${pageContext.request.contextPath}/style/images/edit.gif" />移动到其他版块</a>
			...
			<div class="ListArea">
				<table border="0" cellpadding="0" cellspacing="1" width="100%">
					<tr>
						...
						<td align="center">
							<ul class="TopicFunc" style="margin: 0px; width: 95%;">
								<!--操作列表-->
								<li class="TopicFuncLi">
									<a class="detail" href="#" onclick="return false"><img border="0" src="${pageContext.request.contextPath}/style/images/edit.gif" />详细</a>
