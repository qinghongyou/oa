...
<body class="PageBody" style="margin: 0">
	...
	<div id="Head1">
        ...
        <div id="Head1Right_Button">
            <a target="desktop" href="/desktop?method=show" onclick="return false">
    ...
    <div id="Head2">
        <div id="Head2_Awoke">
            <ul id="AwokeNum">
                <li><a target="desktop" href="javascript:void(0)" onclick="return false">
                ...
                <li class="Line"></li>
				  <!-- 是否有待审批文档的提示1，数量 -->
                <li><a href="${pageContext.request.contextPath}/myTask.jsp" target="right">
		...
		<div id="Head2_FunctionList">
			<marquee style="WIDTH: 755px;" onMouseOver="this.stop()" onMouseOut="this.start()" 
